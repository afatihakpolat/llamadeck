...
## Verification
- `npm run test:run` (154 tests passing, including template-document CLI ingestion, validation exit semantics, command dispatch, authenticated named-pipe requests, and PowerShell round trips)

...
Project-level guide for AI agents working on LlamaDeck. Read this before doing meaningful work. The global orchestration rules in `~/.claude/CLAUDE.md` apply on top of this.
